...
import getopt
import sys
from metrics import windowdiff
from metrics import winpr
...
def computeMeasures(inputText, groundTruthData, producedData):
    ...
    (groundTruthWordBorders, producedDataWordBorders, totalWordCount) = getWordPositionsFromCharacterPositions(inputText, groundTruthData, producedData)
...
def evaluate(X, truth, predictions):
    """Main method of this module."""

    problemsCount = len(truth)
    totalWinDiff = 0
    totalWinR = 0
    totalWinP = 0
    totalWinF = 0
    ...
    return totalWinDiff, totalWinR, totalWinP, totalWinF, outStr


if __name__ == '__main__':
    evaluate(*parse_options())
