...
def schedule(ind):
    a = [0.001, 0.001, 0.001, 0.001, 0.001, 0.001, 0.0005,0.0002,0.0001,0.00005,0.00005,0.00005,0.00005,0.00005,0.00005,0.00005,0.00005,0.00005,0.00005,0.00005,0.00005,0.00005,0.00005,0.00005,0.00005,0.00005,0.00005,0.00005,0.00005,0.00005,0.00005,0.00005,0.00005,0.00005,0.00005,0.00005,0.00005,0.00005,0.00005,0.00005,0.00005,0.00005,0.00005,0.00005,0.00005,0.00005,0.00005,0.00005,0.00005,0.00005,0.00005,0.00005,0.00005]
    return a[ind]
...
test_predicts.to_csv("/output/capsule_sub_with_lr.csv", index=False)

print("Making meta predictions...")

subm = pd.read_csv("/camera_data/train.csv")
submid = pd.DataFrame({'id': subm["id"]})
total_meta_data = pd.concat([submid, pd.DataFrame(total_meta, columns=CLASSES)], axis=1)
total_meta_data.to_csv('/output/capsule_meta_with_lr.csv', index = False)
