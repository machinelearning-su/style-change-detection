...
for i, (train_index, test_index) in enumerate(kf.split(x, y)):
    ...
    cnn1 = Convolution1D(256, 5, padding='valid', strides=3, activation='elu', kernel_initializer="glorot_uniform")(xx)
    cnn1 = SpatialDropout1D(0.1231232556)(cnn1)
    cnn1_max = GlobalMaxPooling1D()(cnn1)
    cnn1_ave = GlobalAveragePooling1D()(cnn1)

    cnn2 = Convolution1D(256, 5, padding='valid', strides=3, activation='elu', kernel_initializer="glorot_uniform")(xx)
    cnn2 = SpatialDropout1D(0.10348347384)(cnn2)
    cnn2_max = GlobalMaxPooling1D()(cnn2)
    cnn2_ave = GlobalAveragePooling1D()(cnn2)

    cnn3 = Convolution1D(256, 5, padding='valid', strides=3, activation='elu', kernel_initializer="glorot_uniform")(xx)
    cnn3 = SpatialDropout1D(0.14959459454233)(cnn3)
    ...
    cnn = Dropout(0.1812178568567956)(cnn)

    dense1 = Dense(96, activation='elu')(cnn)  # 144

    dense1 = Dropout(0.15966141017220734)(dense1)

    auxiliary_input = Input(shape=(5,), name='aux_input')

    z = Concatenate()([dense1, auxiliary_input])
...
result.to_csv("/output/pure_cnn_glove_sub.csv", index=False)
